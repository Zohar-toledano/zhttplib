...
HTTP_METHOD ZServer::strToHTTPMethod(std::string method)
{
...
std::string ZServer::HTTPMethodToStr(HTTP_METHOD method)
{
	switch (method)
	{
...
HTTP_VERSION ZServer::strToHTTPVersion(std::string version)
{
...
std::string ZServer::HTTPVersionToStr(HTTP_VERSION version)
{
	switch (version)
	{
